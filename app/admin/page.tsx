                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
                    ...
                    <Link href="/admin/estadisticas" style={{ textDecoration: 'none' }}>
                        <div className="dashboard-card" style={{
                            ...
                            <h2 style={{ color: '#fff', fontSize: '1.5rem', marginBottom: '10px' }}>Estadísticas</h2>
                            <p style={{ color: '#aaa', fontSize: '0.9rem' }}>
                                Reportes de ingresos, autos reparados, métricas de rendimiento y contabilidad mensual.
                            </p>
                        </div>
                    </Link>
                    ...
                    {/* Card 7: Calendario */}
                    <Link href="/admin/calendario" style={{ textDecoration: 'none' }}>
                        <div className="dashboard-card" style={{
                            background: '#1a1a1a',
                            padding: '30px',
                            borderRadius: '10px',
                            ...
                            <h2 style={{ color: '#fff', fontSize: '1.5rem', marginBottom: '10px' }}>Calendario</h2>
                            <p style={{ color: '#aaa', fontSize: '0.9rem' }}>
                                Agenda de turnos, citas programadas y eventos del taller. Visualización mensual y gestión de horarios.
                            </p>
                        </div>
                    </Link>
